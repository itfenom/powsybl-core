...
public class UcteImporterTest {
    ...
    public void elementNameTest() {
        ...
        assertEquals("Test Line", network.getLine("F_SU1_12 F_SU2_11 1").getProperty("elementName").orElse(null));
        // Test Dangling Line element name
        assertEquals("Test DL", network.getDanglingLine("XG__F_21 F_SU1_21 1").getProperty("elementName").orElse(null));
        // Test Switch element name
        assertEquals("Test Coupler", network.getSwitch("F_SU1_12 F_SU1_11 1").getProperty("elementName").orElse(null));
        // Test 2WT element name
        assertEquals("Test 2WT 1", network.getBranch("F_SU1_11 F_SU1_21 1").getProperty("elementName").orElse(null));
        assertEquals("Test 2WT 2", network.getBranch("B_SU1_11 B_SU1_21 1").getProperty("elementName").orElse(null));
        // Test tie line
        ...
        assertEquals(expectedElementName1, tieLine1.getProperty("elementName_1").orElse(null));
        assertEquals(expectedElementName2, tieLine1.getProperty("elementName_2").orElse(null));
        ...
        assertEquals(expectedElementName1, tieLine2.getProperty("elementName_1").orElse(null));
        assertEquals(expectedElementName2, tieLine2.getProperty("elementName_2").orElse(null));
    }
